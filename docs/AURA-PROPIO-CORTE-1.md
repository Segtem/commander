> Movido desde `Segtem/oracle` (`estudios/AURA-PROPIO-CORTE-1.md`) el 2026-09-23, cuando Aura pasó a ser su propio
> proyecto. Las rutas `estudios/`, `nucleo/` y `tools/` que cita son de ese repositorio.
